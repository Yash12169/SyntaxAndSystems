...
const ThemeController = () => {
  ...
  return (
    <div>
      <div style={{zIndex: 10}}
        className="btn shadow-none border-none flex hover:bg-white hover:bg-opacity-[0.1] justify-center items-center bg-transparent  w-fit  h-[70px] rounded-[15px]  cursor-pointer p-0"
